/**
 * Airport connection map periods: nine fixed open dates per year (Europe/Lisbon).
 *
 * On each open date the previous period is frozen and a new live period begins.
 */
