...
export const gl: Messages = {
  ...
  station: {
    ...
    airportConnectionsIberianMapAlt: "Mapa de voos ibéricos desde {{name}}",
    airportConnectionsAllFlightsMapAlt: "Mapa de todos os voos desde {{name}}",
  ...
  rankings: {
    ...
    airportDestinationIntro:
      "O aeroporto continental con máis destinos directos de cada país, segundo os datos de conexións recollidos — non segundo a frecuencia de voos mostreados. Os aeroportos das illas non contan.",
  ...
  map: {
    ...
    legendSpainCercanias: "Renfe Cercanías (en directo)",
    legendSpainLongDistance: "Renfe longa distancia (en directo)",
    ...
    visitedMapTitle: "O teu mapa de estacións visitadas",
    visitedMapIntro:
      "Crea un PNG das estacións que marcaches como visitadas. Xérase no teu navegador e nunca se envía aos nosos servidores.",
    visitedMapDownload: "Descargar o meu mapa visitado",
    visitedMapEmpty: "Marca estacións como visitadas para descargar o teu mapa.",
    visitedMapCount_one: "{{count}} estación visitada",
    visitedMapCount_other: "{{count}} estacións visitadas",
    visitedMapBusy: "Preparando o mapa…",
    visitedMapError: "Non se puido crear o mapa. Téntao de novo.",
  },
  tickets: {
