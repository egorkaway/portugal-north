...
export const gl: Messages = {
  ...
  home: {
    ...
    pageOfBefore: "Páxina {{current}} de",
    goToLastPage: "Ir á páxina {{page}}",
  ...
  station: {
    ...
    airportConnectionsIntro:
      "{{destinations}} destinos con voos directos recollidos ata agora.",
    airportConnectionsLegend:
      "As cores das liñas mostran a frecuencia de cada ruta nas mostras deste período:",
    ...
    monthlyTempBody:
      "Medias a partir das nosas mostras recentes de temperatura nesta estación.",
  ...
  lines: {
    ...
    subtitle: "Todas as liñas dos nosos datos, as estacións de cada unha e que trens paran",
    intro:
      "Explora as liñas ferroviarias de Portugal — ademais das liñas transfronteirizas e de metro dos nosos datos. Cada liña mostra as súas estacións cos servizos que paran alí.",
    backToLines: "Volver ás liñas",
    portugalHeading: "Liñas ferroviarias de Portugal",
    spainHeading: "Liñas transfronteirizas e de España",
    metroHeading: "Liñas de metro",
    stationCount_one: "{{count}} estación",
    stationCount_other: "{{count}} estacións",
    lineCount_one: "{{count}} liña",
    lineCount_other: "{{count}} liñas",
    servicesLabel: "Servizos",
    historicBadge: "Histórica",
    orderingNote:
      "As estacións aparecen en orde xeográfica aproximada ao longo da liña, non na secuencia oficial de paradas.",
    servicesNote:
      "Os tipos de servizo son os rexistrados para cada estación nos nosos datos e poden non reflectir todos os trens cada día.",
    stationsHeading: "Estacións desta liña",
    alsoOn: "Tamén en",
    noServiceData: "Sen datos de tipo de servizo",
    emptyLine: "Aínda non hai estacións rexistradas nesta liña.",
    viewAllLines: "Ver todas as liñas",
  },
  departures: {
  ...
  arrivals: {
    ...
    unavailable: "Chegadas en directo temporalmente non dispoñibles",
  ...
  trip: {
    ...
    emptyBody:
      "Abre unha páxina de estación, preme Coller nunha saída ou chegada que continúa, ou Recibir nunha chegada final, e a conta atrás aparecerá aquí.",
    departureCountdown: "Conta atrás para a saída",
    arrivalCountdown: "Conta atrás para a chegada",
    departed: "Partiu",
    arrived: "Chegou",
    departedAt: "Partiu ás {{time}}",
    arrivedAt: "Chegou ás {{time}}",
    expectedDeparture: "Saída prevista ás {{time}}",
    expectedArrival: "Chegada prevista ás {{time}}",
  ...
  map: {
    ...
    intro:
      "Cada hexágono é unha célula H3 arredor dunha estación da nosa lista. As máis movidas e as de tráfico medio comparten hexágonos na resolución 7 (verde vs azul); as máis calmas usan hexágonos menores na resolución 9.",
    loading: "Cargando mapa…",
    unavailable: "Os datos de actividade das estacións non están dispoñibles temporalmente.",
    legendTitle: "Actividade do hexágono",
  ...
  tickets: {
    ...
    portoVigoRenfeNote:
      "O Porto–Vigo (Celta): os billetes en liña véndense na Renfe, non na CP — non están dispoñibles na web nin na app da CP. As billeteiras das estacións CP aínda poden vender esta ruta.",
    portugalServiceAP:
      "Alfa Pendular — o servizo máis rápido nos corredores principais (Lisboa–Porto, tamén Faro e Braga); reserva con antelación para mellor prezo.",
  ...
  footer: {
    ...
    sovnikTitle: "Sovnik",
    sovnikDesc:
      "Aprende castelán, portugués, galego, catalán, éuscaro e outras linguas ibéricas con cuestionarios de vocabulario e apps móbiles.",
  ...
  meta: {
    ...
    lines: {
      title: "Liñas Ferroviarias e Estacións | Viaxe Ibérica Sostible",
      description:
        "Explora todas as liñas ferroviarias de Portugal (ademais de liñas transfronteirizas e de metro), as estacións de cada liña e que servizos — Alfa Pendular, Intercidades, Regional, Urbano — paran alí.",
      ogDescription:
        "Liñas ferroviarias de Portugal coas estacións de cada liña e os servizos que paran alí.",
      lineTitle: "{{line}} — Estacións e Servizos | {{site}}",
      lineDescription:
        "As {{count}} estacións de {{line}} e os servizos que paran alí: {{services}}.",
      lineOgDescription:
        "{{line}}: {{count}} estacións e servizos — {{services}}.",
    },
    map: {
