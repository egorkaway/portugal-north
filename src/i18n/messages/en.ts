...
export const en: Messages = {
  ...
  home: {
    ...
    pageOfBefore: "Page {{current}} of",
    goToLastPage: "Go to page {{page}}",
  ...
  station: {
    ...
    airportConnectionsIntro:
      "{{destinations}} destinations with direct flights collected so far.",
    ...
    airportConnectionsMapAlt: "Flight connections map from {{name}}",
    downloadConnectionsMap: "Download connections map",
    airportConnectionsFlights_one: "{{count}} flight",
    airportConnectionsFlights_other: "{{count}} flights",
  ...
  arrivals: {
    title: "Next arrivals",
    unavailable: "Live arrivals are temporarily unavailable",
    none: "No upcoming arrivals found for the next few hours.",
  ...
  trip: {
    ...
    emptyBody:
      "Open any station page, tap \"Take\" on a departure or continuing arrival, or \"Meet\" on a terminating arrival, and your countdown will appear here.",
  ...
  map: {
    ...
    intro:
      "Each hex is an H3 cell around a station in our list. Busiest and mid-traffic stations share resolution-7 hexes (green vs blue); quieter ones use smaller resolution-9 hexes.",
    loading: "Loading map…",
    unavailable: "Station activity data is temporarily unavailable.",
    legendTitle: "Hex activity",
