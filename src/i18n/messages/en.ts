...
export const en: Messages = {
  ...
  station: {
    ...
    airportConnectionsIberianTitle: "Iberian flights",
    airportConnectionsAllFlightsTitle: "All flights",
    airportConnectionsIberianMapAlt: "Iberian flights map from {{name}}",
    airportConnectionsAllFlightsMapAlt: "All flights map from {{name}}",
  ...
  rankings: {
    ...
    trainSpotlightTrainLabel: "Train {{number}} · {{serviceType}}",
    ...
    airportDestinationIntro:
      "The continental airport with the most direct destinations in each country, based on our collected connection data — not how many flights we sampled. Island airports are not counted.",
  ...
  map: {
    ...
    legendSpainCercanias: "Renfe Cercanías (live)",
    legendSpainLongDistance: "Renfe long-distance (live)",
    spainTrainCercanias: "Cercanías",
    spainTrainLongDistance: "Long distance",
  ...
  footer: {
    ...
    appStoreBadgeAlt: "Download VeryStays: Trains in Iberia on the App Store",
