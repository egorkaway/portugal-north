...
export const ca: Messages = {
  ...
  station: {
    ...
    airportConnectionsIberianTitle: "Vols ibèrics",
    airportConnectionsAllFlightsTitle: "Tots els vols",
    airportConnectionsIberianMapAlt: "Mapa de vols ibèrics des de {{name}}",
    airportConnectionsAllFlightsMapAlt: "Mapa de tots els vols des de {{name}}",
  ...
  rankings: {
    ...
    airportDestinationIntro:
      "L'aeroport continental amb més destins directes de cada país, segons les dades de connexions recollides — no segons quants vols hem mostrejat. Els aeroports de les illes no compten.",
    ...
    airportDestinationMostPt: "Més destins (Portugal)",
  ...
  map: {
    ...
    legendSpainCercanias: "Renfe Cercanías (en directe)",
    legendSpainLongDistance: "Renfe llarga distància (en directe)",
    spainTrainCercanias: "Cercanías",
    spainTrainLongDistance: "Llarga distància",
    ...
    overviewIberianTitle: "Descarregar mapa general de la Península Ibèrica",
  ...
  footer: {
    ...
    appStoreBadgeAlt: "Descarregar VeryStays: Trains in Iberia a l'App Store",
    alsoFromUs: "També nostres",
    caminoTitle: "My Personal Camino de Santiago",
    caminoDesc:
      "App per a iOS i Android per seguir el camí i el teu progrés al Camí de Santiago.",
