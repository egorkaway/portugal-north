...
export const ca: Messages = {
  ...
  home: {
    ...
    pageOfBefore: "Pàgina {{current}} de",
    goToLastPage: "Anar a la pàgina {{page}}",
  ...
  station: {
    ...
    airportConnectionsIntro:
      "{{destinations}} destinacions amb vols directes recollides fins ara.",
    airportConnectionsLegend:
      "Els colors de les línies mostren la freqüència de cada ruta a les mostres d'aquest període:",
  ...
  arrivals: {
    ...
    unavailable: "Arribades en directe temporalment no disponibles",
  ...
  trip: {
    ...
    emptyBody:
      "Obre una pàgina d'estació, prem Agafar en una sortida o arribada que continua, o Rebre en una arribada final, i el compte enrere apareixerà aquí.",
    departureCountdown: "Compte enrere per a la sortida",
    arrivalCountdown: "Compte enrere per a l'arribada",
    departed: "Ha sortit",
    arrived: "Ha arribat",
    departedAt: "Ha sortit a les {{time}}",
    arrivedAt: "Ha arribat a les {{time}}",
    expectedDeparture: "Sortida prevista a les {{time}}",
    expectedArrival: "Arribada prevista a les {{time}}",
    ...
    departureAt: "Surt a les {{time}}",
    arrivalAt: "Arriba a les {{time}}",
  ...
  map: {
    ...
    intro:
      "Cada hexàgon és una cel·la H3 al voltant d'una estació de la nostra llista. Les més actives i les de trànsit mitjà comparteixen hexàgons a resolució 7 (verd vs blau); les més tranquil·les usen hexàgons més petits a resolució 9.",
    loading: "Carregant mapa…",
    unavailable: "Les dades d'activitat d'estacions no estan disponibles temporalment.",
    legendTitle: "Activitat de l'hexàgon",
    ...
    overviewReliabilityAlt:
      "Mapa de Portugal continental amb estacions per puntuació de puntualitat",
    overviewReliabilityDownload: "Descarregar mapa de fiabilitat",
  },
  tickets: {
    ...
    portugalServiceAP:
      "Alfa Pendular — el servei més ràpid als corredors principals (Lisboa–Porto, també Faro i Braga); reserva amb antelació per al millor preu.",
  ...
  footer: {
    ...
    caminoDesc:
      "App per a iPhone per seguir el camí i el teu progrés al Camí de Santiago.",
