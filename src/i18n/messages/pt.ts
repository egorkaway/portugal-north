...
export const pt: Messages = {
  ...
  station: {
    ...
    airportConnectionsIberianTitle: "Voos ibéricos",
    airportConnectionsAllFlightsTitle: "Todos os voos",
    airportConnectionsIberianMapAlt: "Mapa de voos ibéricos a partir de {{name}}",
    airportConnectionsAllFlightsMapAlt: "Mapa de todos os voos a partir de {{name}}",
  ...
  rankings: {
    ...
    airportDestinationIntro:
      "O aeroporto continental com mais destinos diretos em cada país, com base nos dados de ligações recolhidos — não na frequência de voos amostrados. Os aeroportos das ilhas não entram no ranking.",
    airportDestinationLoading: "A carregar rankings de aeroportos…",
    airportDestinationUnavailable: "Os rankings de ligações aéreas estão temporariamente indisponíveis.",
    airportDestinationNoData: "Ainda não há dados de ligações aéreas.",
    airportDestinationMostPt: "Mais destinos (Portugal)",
  ...
  map: {
    ...
    subtitle: "O tamanho dos hexágonos mostra atividade e as cores das estações mostram fiabilidade em Portugal e Espanha",
    intro:
      "As estações mais movimentadas e as de tráfego médio mantêm hexágonos maiores, dimensionados pelas partidas e chegadas amostradas. As estações ativas mais calmas passam a pontos coloridos pela fiabilidade, enquanto as inativas ou com poucas amostras ficam em hexágonos pequenos.",
    loading: "A carregar mapa…",
    unavailable: "Os dados de atividade das estações estão temporariamente indisponíveis.",
    legendTitle: "Atividade da estação",
    legendBusy: "Movimentadas e tráfego médio (hexágonos maiores)",
    legendMid: "Tráfego médio (hexágonos maiores)",
    legendQuiet: "Inativa ou com poucas amostras (hexágonos pequenos)",
    legendReliableHigh: "Fiável",
    legendReliableMid: "Fiabilidade mista",
    legendReliableLow: "Pouco fiável",
    tooltipScore: "{{score}}/10",
    tooltipNoScore: "Sem pontuação de fiabilidade",
    tooltipBiggerHex: "Hexágono maior",
    ...
    legendSpainCercanias: "Renfe Cercanías (ao vivo)",
    legendSpainLongDistance: "Renfe longa distância (ao vivo)",
    ...
    yourLocation: "Está aqui",
    yourLocationHint: "Localização atual",
    ...
    overviewActivityAlt: "Mapa de Portugal continental com hexágonos por atividade ferroviária amostrada",
    ...
    overviewIberianTitle: "Descarregar mapa de visão geral da Península Ibérica",
    overviewIberianIntro:
      "Um mapa estático quadrado de fiabilidade de Portugal e Espanha, com as mesmas pontuações de pontualidade da app móvel quando há dados suficientes.",
    overviewIberianReliabilityAlt:
      "Mapa quadrado da Península Ibérica com estações por pontuação de pontualidade",
    visitedMapTitle: "O seu mapa de estações visitadas",
    visitedMapIntro:
      "Crie um PNG das estações que marcou como visitadas. É gerado no seu browser e nunca é enviado para os nossos servidores.",
    visitedMapDownload: "Descarregar o meu mapa visitado",
    visitedMapEmpty: "Marque estações como visitadas para descarregar o mapa.",
    visitedMapCount_one: "{{count}} estação visitada",
    visitedMapCount_other: "{{count}} estações visitadas",
    visitedMapBusy: "A preparar o mapa…",
    visitedMapError: "Não foi possível criar o mapa. Tente de novo.",
  },
  tickets: {
  ...
  footer: {
    ...
    appStoreBadgeAlt: "Descarregar VeryStays: Trains in Iberia na App Store",
  ...
  meta: {
    ...
    map: {
      ...
      description:
        "Mapa interativo das estações CP em Portugal continental com hexágonos dimensionados por partidas e chegadas amostradas.",
      ogDescription:
        "Veja quais estações CP são mais movimentadas nas nossas amostras de partidas, num mapa hexagonal de Portugal.",
    },
    trip: {
