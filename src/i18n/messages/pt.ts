...
export const pt: Messages = {
  ...
  home: {
    ...
    goToLastPage: "Ir para a página {{page}}",
  ...
  station: {
    ...
    airportConnectionsIntro:
      "{{destinations}} destinos com voos diretos recolhidos até agora.",
    airportConnectionsLegend:
      "As cores das linhas mostram a frequência de cada rota nas amostras deste período:",
  ...
  arrivals: {
    ...
    unavailable: "Chegadas em direto temporariamente indisponíveis",
  ...
  trip: {
    ...
    emptyBody:
      "Abra uma página de estação, toque em Apanhar numa partida ou chegada que continua, ou em Encontrar numa chegada final, e a contagem aparecerá aqui.",
    departureCountdown: "Contagem para a partida",
    arrivalCountdown: "Contagem para a chegada",
    departed: "Partiu",
    arrived: "Chegou",
    departedAt: "Partiu às {{time}}",
    arrivedAt: "Chegou às {{time}}",
    expectedDeparture: "Partida prevista às {{time}}",
    expectedArrival: "Chegada prevista às {{time}}",
