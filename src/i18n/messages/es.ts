...
export const es: Messages = {
  ...
  home: {
    ...
    pageOfBefore: "Página {{current}} de",
    goToLastPage: "Ir a la página {{page}}",
  ...
  station: {
    ...
    airportConnectionsTitle: "Conexiones aéreas",
    airportConnectionsIntro:
      "{{destinations}} destinos con vuelos directos recogidos hasta ahora.",
    airportConnectionsLegend:
      "Los colores de las líneas muestran la frecuencia de cada ruta en las muestras de este período:",
    airportConnectionsLegendBusy: "5+ vuelos",
    airportConnectionsLegendModerate: "3–4 vuelos",
    airportConnectionsLegendLight: "1–2 vuelos",
    airportConnectionsMapAlt: "Mapa de conexiones aéreas desde {{name}}",
    downloadConnectionsMap: "Descargar mapa de conexiones",
    airportConnectionsFlights_one: "{{count}} vuelo",
    airportConnectionsFlights_other: "{{count}} vuelos",
  ...
  lines: {
    title: "Líneas ferroviarias",
    subtitle: "Todas las líneas de nuestros datos, sus estaciones y qué trenes paran",
    intro:
      "Explora las líneas ferroviarias de Portugal — además de las líneas transfronterizas y de metro de nuestros datos. Cada línea muestra sus estaciones con los servicios que paran allí.",
    backToLines: "Volver a las líneas",
    portugalHeading: "Líneas ferroviarias de Portugal",
    spainHeading: "Líneas transfronterizas y de España",
    metroHeading: "Líneas de metro",
    ...
    orderingNote:
      "Las estaciones se muestran en orden geográfico aproximado a lo largo de la línea, no en la secuencia oficial de paradas.",
    servicesNote:
      "Los tipos de servicio son los registrados para cada estación en nuestros datos y pueden no reflejar todos los trenes cada día.",
    stationsHeading: "Estaciones de esta línea",
    alsoOn: "También en",
    noServiceData: "Sin datos de tipo de servicio",
    emptyLine: "Aún no hay estaciones registradas en esta línea.",
  ...
  arrivals: {
    ...
    unavailable: "Llegadas en directo temporalmente no disponibles",
  ...
  trip: {
    ...
    emptyBody:
      "Abre una página de estación, pulsa Tomar en una salida o llegada que continúa, o Recibir en una llegada final, y la cuenta atrás aparecerá aquí.",
    departureCountdown: "Cuenta atrás para la salida",
    arrivalCountdown: "Cuenta atrás para la llegada",
    departed: "Salió",
    arrived: "Llegó",
    departedAt: "Salió a las {{time}}",
    arrivedAt: "Llegó a las {{time}}",
    expectedDeparture: "Salida prevista a las {{time}}",
    expectedArrival: "Llegada prevista a las {{time}}",
    ...
    historyDeleteConfirmBodyGeneric: "¿Quitar este viaje del historial? Esta acción no se puede deshacer.",
  ...
  map: {
    ...
    overviewActivityTitle: "Actividad de estaciones",
    overviewActivityAlt: "Mapa de Portugal continental con hexágonos H3 por actividad ferroviaria muestreada",
    overviewActivityDownload: "Descargar mapa de actividad",
    overviewReliabilityTitle: "Fiabilidad de estaciones",
    overviewReliabilityAlt:
      "Mapa de Portugal continental con estaciones por puntuación de puntualidad",
    overviewReliabilityDownload: "Descargar mapa de fiabilidad",
  },
  tickets: {
    ...
    portugalServiceAP:
      "Alfa Pendular — el servicio más rápido en los corredores principales (Lisboa–Oporto, también Faro y Braga); reserva con antelación para mejor precio.",
    ...
    tipUrban: "Para trayectos cortos, Urban/Regional suele ser mejor valor — y cada persona necesita su propia tarjeta.",
    disclaimer:
    ...
    portugalLocalCardNote:
      "En trenes locales y de cercanías (y en el metro), cada viajero necesita su propia tarjeta de viaje. No se pueden cargar billetes de varias personas en una sola tarjeta si viajáis en grupo. Valida siempre el billete o la tarjeta antes de subir — en los validadores o tornos.",
    portugalResidentPassNote:
      "Los abonos más largos (a menudo de 30 o 90 días) a veces están reservados a residentes y pueden exigir identificación local o empadronamiento. Los turistas suelen tener solo billetes ocasionales o títulos cortos de 1 a 3 días — comprueba qué puedes comprar antes de contar con un abono mensual.",
    ...
    metroPortoTips:
      "Una tarjeta por persona — no compartáis un solo Andante en grupo. Valida en los tornos o validadores al entrar.",
    ...
    metroLisboaTips:
      "Una tarjeta por persona — no se pueden poner billetes de varios viajeros en una sola navegante®. Carga viajes en las máquinas y valida antes de viajar.",
  ...
  meta: {
    ...
    lines: {
      title: "Líneas Ferroviarias y Estaciones | Viaje Ibérico Sostenible",
      description:
        "Explora todas las líneas ferroviarias de Portugal (además de líneas transfronterizas y de metro), las estaciones de cada línea y qué servicios — Alfa Pendular, Intercidades, Regional, Urbano — paran allí.",
      ogDescription:
        "Líneas ferroviarias de Portugal con las estaciones de cada línea y los servicios que paran allí.",
      lineTitle: "{{line}} — Estaciones y Servicios | {{site}}",
      lineDescription:
        "Las {{count}} estaciones de {{line}} y los servicios que paran allí: {{services}}.",
      lineOgDescription:
        "{{line}}: {{count}} estaciones y servicios — {{services}}.",
    },
    map: {
