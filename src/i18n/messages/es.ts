...
export const es: Messages = {
  ...
  station: {
    ...
    airportConnectionsIberianTitle: "Vuelos ibéricos",
    airportConnectionsAllFlightsTitle: "Todos los vuelos",
    airportConnectionsIberianMapAlt: "Mapa de vuelos ibéricos desde {{name}}",
    airportConnectionsAllFlightsMapAlt: "Mapa de todos los vuelos desde {{name}}",
    ...
    longDistanceIntro:
      "Esta parada solo tiene servicio regional o urbano. Para trenes Alfa Pendular o {{icService}}, prueba estas estaciones cercanas:",
  ...
  rankings: {
    ...
    mostReliable: "Top 7 más fiables (Portugal)",
    leastReliable: "Bottom 7 menos fiables (Portugal)",
    ...
    spainMostReliable: "Top 7 más fiables (España)",
    spainLeastReliable: "Bottom 7 menos fiables (España)",
    downloadReliabilityCsv: "Descargar CSV",
    downloadStationCsv: "Descargar CSV",
    trainSpotlightTitle: "Trenes destacados en Portugal",
    trainSpotlightIntro:
      "Los tres trenes más retrasados a partir de nuestras muestras de retrasos en llegada de CP en Portugal. Las estaciones muestreadas juntas cuentan como un avistamiento. Hacen falta al menos tres avistamientos en dos días distintos, y uno en la última semana.",
    trainSpotlightLoading: "Cargando trenes destacados…",
    trainSpotlightNoData: "Aún no hay muestras suficientes de trenes.",
    mostReliableTrain: "Los 3 trenes más fiables",
    ...
    airportDestinationIntro:
      "El aeropuerto continental con más destinos directos de cada país, según nuestros datos de conexiones recogidos — no según cuántos vuelos hemos muestreado. Los aeropuertos de las islas no cuentan.",
    ...
    airportDestinationMostPt: "Más destinos (Portugal)",
    airportDestinationMostEs: "Más destinos (España)",
  ...
  map: {
    ...
    subtitle: "El tamaño de los hexágonos muestra actividad y los colores de las estaciones muestran fiabilidad en Portugal y España",
    intro:
      "Las estaciones más activas y las de tráfico medio siguen como hexágonos más grandes, según salidas y llegadas muestreadas. Las estaciones activas más tranquilas pasan a puntos coloreados por fiabilidad, mientras que las inactivas o con pocas muestras siguen como hexágonos pequeños.",
    loading: "Cargando mapa…",
    unavailable: "Los datos de actividad de estaciones no están disponibles temporalmente.",
    legendTitle: "Actividad de la estación",
    legendBusy: "Activas y tráfico medio (hexágonos más grandes)",
    legendMid: "Tráfico medio (hexágonos más grandes)",
    legendQuiet: "Inactiva o con pocas muestras (hexágonos pequeños)",
    ...
    legendSpainCercanias: "Renfe Cercanías (en vivo)",
    legendSpainLongDistance: "Renfe larga distancia (en vivo)",
    spainTrainCercanias: "Cercanías",
    spainTrainLongDistance: "Larga distancia",
    ...
    overviewActivityAlt: "Mapa de Portugal continental con hexágonos por actividad ferroviaria muestreada",
    ...
    overviewIberianTitle: "Descargar mapa general de la Península Ibérica",
  ...
  footer: {
    ...
    appStoreBadgeAlt: "Descargar VeryStays: Trains in Iberia en el App Store",
    alsoFromUs: "También nuestros",
    caminoTitle: "My Personal Camino de Santiago",
    caminoDesc:
      "App para iOS y Android para seguir el camino y tu progreso en el Camino de Santiago.",
  ...
  meta: {
    ...
    map: {
      ...
      description:
        "Mapa interactivo de estaciones CP en Portugal continental con hexágonos según salidas y llegadas muestreadas.",
      ogDescription:
        "Mira qué estaciones CP son más activas en nuestras muestras de salidas, en un mapa hexagonal de Portugal.",
    },
    trip: {
