 ...
 * Shown on the map as `Airport Destination` markers. We do **not** give them
 * station pages. Connection maps from the busiest non-peninsula destinations
 * are written separately under `public/maps/airports/external/`.
 *
