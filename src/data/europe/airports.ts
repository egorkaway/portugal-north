...
export const europeDestinationAirports: Station[] = [
  ...
  {
    name: "Clermont-Ferrand Auvergne airport (CFE)",
    country: "fr",
    lines: ["CFE"],
    types: ["Airport Destination"],
    lat: 45.786701,
  ...
  {
    name: "Craiova International Airport (CRA)",
    country: "ro",
    lines: ["CRA"],
    types: ["Airport Destination"],
    lat: 44.3181,
  ...
  {
    name: "Figari Sud-Corse Airport (FSC)",
    country: "fr",
    lines: ["FSC"],
    types: ["Airport Destination"],
    lat: 41.50185,
  ...
  {
    name: "Gloucestershire Airport (GLO)",
    country: "gb",
    lines: ["GLO"],
    types: ["Airport Destination"],
    lat: 51.894199,
  ...
  {
    name: "London Oxford Airport (OXF)",
    country: "gb",
    lines: ["OXF"],
    types: ["Airport Destination"],
    lat: 51.836899,
  ...
  {
    name: "Perpignan-Rivesaltes (Llabanère) Airport (PGF)",
    country: "fr",
    lines: ["PGF"],
    types: ["Airport Destination"],
    lat: 42.740398,
