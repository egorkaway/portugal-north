/**
 * Short editorial blurbs for station and airport pages (English).
...
export const stationSummaries: Record<string, string> = {
  ...
  "Queluz - Belas":
    "High-frequency commuter halt between Amadora and Cacém on the Sintra line. Trains reach Rossio in well under half an hour, making Belas and western Amadora workable for budget stays outside the tourist core. Monte Abrão, one stop away, is the usual rail access for Queluz National Palace.",
  "Porto-Campanhã":
