...
export const pt: MobileMessages = {
  ...
  home: {
    ...
    browseLines: 'Ver linhas de comboio',
  },
  station: {
  ...
  lines: {
    ...
    spainHeading: 'Linhas transfronteiriças e espanholas',
    stationCount_one: '{{count}} estação',
    stationCount_other: '{{count}} estações',
    servicesNote: 'Os tipos de serviço são os registados para cada estação nos nossos dados e podem não refletir todos os comboios em todos os dias.',
    stationsHeading: 'Estações nesta linha',
    alsoOn: 'Também em',
    emptyLine: 'Ainda não há estações registadas para esta linha.',
    orderingNote: 'As estações estão listadas por ordem geográfica aproximada ao longo da linha, não pela sequência oficial de paragens.',
  ...
  map: {
    ...
    hideVisitedA11y: 'Ocultar estações visitadas',
    showAllStationsA11y: 'Mostrar todas as estações',
    openStation: 'Abrir estação',
    openDetails: 'Detalhes',
    flightsFromIberia: 'Voos a partir da Península Ibérica',
    noIberianFlights: 'Sem voos ibéricos na amostra mais recente.',
  ...
  rankings: {
    ...
    mostReliable: 'Top 7 mais fiáveis (Portugal)',
    leastReliable: 'Bottom 7 menos fiáveis (Portugal)',
    spainMostReliable: 'Top 7 mais fiáveis (Espanha)',
    spainLeastReliable: 'Bottom 7 menos fiáveis (Espanha)',
    ...
    trainSpotlightTitle: 'Destaques de comboios (Portugal)',
