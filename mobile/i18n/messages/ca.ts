...
export const ca: MobileMessages = {
  ...
  home: {
    ...
    browseLines: 'Veure línies de tren',
  },
  station: {
    ...
    longDistanceIntro:
      'Aquesta parada té només servei regional o urbà. Per a trens Alfa Pendular o {{icService}}, prova aquestes estacions:',
  },
  lines: {
    ...
    spainHeading: 'Línies transfrontereres i espanyoles',
    stationCount_one: '{{count}} estació',
    stationCount_other: '{{count}} estacions',
    servicesNote: 'Els tipus de servei són els registrats per a cada estació a les nostres dades i poden no reflectir tots els trens cada dia.',
    stationsHeading: 'Estacions en aquesta línia',
    alsoOn: 'També a',
    emptyLine: 'Encara no hi ha estacions registrades per a aquesta línia.',
    orderingNote: 'Les estacions es listen en ordre geogràfic aproximat al llarg de la línia, no en la seqüència oficial de parades.',
    viewAllLines: 'Veure totes les línies',
    notFound: 'Línia no trobada',
  },
  departures: {
  ...
  trip: {
    ...
    shareA11y: 'Compartir viatge',
    shareTrip: 'Compartir viatge',
    shareFailedTitle: 'No s’ha pogut compartir',
    shareFailedBody: 'Alguna cosa ha anat malament en preparar la imatge del viatge.',
  ...
  sovnik: {
    title: 'Aprèn llengües ibèriques',
    body: 'Sovnik t’ajuda a aprendre espanyol, portuguès, gallec, català, basc i més amb proves de vocabulari i aplicacions mòbils.',
    cta: 'Descobreix Sovnik',
  },
  map: {
    ...
    hideVisitedA11y: 'Amaga les estacions visitades',
    showAllStationsA11y: 'Mostra totes les estacions',
    openStation: 'Obrir estació',
    openDetails: 'Detalls',
    flightsFromIberia: 'Vols des de la Península Ibèrica',
    noIberianFlights: 'Sense vols ibèrics a la darrera mostra.',
  ...
  rankings: {
    ...
    trainSpotlightTitle: 'Trens destacats (Portugal)',
  ...
  tickets: {
    ...
    proBody: 'Desbloqueja Pro amb una subscripció mensual. Gestiona el teu pla en qualsevol moment des d’aquí.',
    proCta: 'Veure plans Pro',
    proActiveTitle: 'Tens Pro',
  ...
  onboarding: {
    ...
    locationBody:
      'La ubicació és opcional. Ordena estacions per distància, alimenta el widget de l\'estació més propera i et pot avisar quan arribes a grans hubs. Sempre funciona millor en segon pla; En usar l\'app encara ajuda amb l\'app oberta.',
    locationBodyAndroid:
    ...
    notificationsBody:
      'Quan prems Agafar en una sortida, et podem recordar minuts abans que surti el tren. La ubicació també et pot avisar quan arribes a estacions concurrides — Sempre funciona millor amb l\'app tancada.',
