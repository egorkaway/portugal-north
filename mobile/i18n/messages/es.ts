...
export const es: MobileMessages = {
  ...
  airport: {
    ...
    intro: '{{destinations}} destinos con vuelos directos recogidos hasta ahora.',
    legend: 'Los colores de las líneas muestran la frecuencia de cada ruta en las muestras de este período:',
    legendBusy: '5+ vuelos',
  ...
  sovnik: {
    title: 'Aprende lenguas ibéricas',
    body: 'Sovnik te ayuda a aprender español, portugués, gallego, catalán, euskera y más con pruebas de vocabulario y aplicaciones móviles.',
    cta: 'Descubre Sovnik',
  },
  map: {
    ...
    hideVisitedA11y: 'Ocultar estaciones visitadas',
    showAllStationsA11y: 'Mostrar todas las estaciones',
    openStation: 'Abrir estación',
    openDetails: 'Detalles',
    flightsFromIberia: 'Vuelos desde la Península Ibérica',
    noIberianFlights: 'Sin vuelos ibéricos en la última muestra.',
  ...
  rankings: {
    ...
    trainSpotlightTitle: 'Trenes destacados (Portugal)',
  ...
  onboarding: {
    ...
    locationBody:
      'La ubicación es opcional. Ordena estaciones por distancia, alimenta el widget de la estación más cercana y puede avisarte al llegar a grandes hubs. Siempre funciona mejor en segundo plano; Al usar la app aún ayuda con la app abierta.',
    locationBodyAndroid:
    ...
    notificationsBody:
      'Cuando pulses Tomar en una salida, podemos recordártelo minutos antes de que salga el tren. La ubicación también puede avisarte al llegar a estaciones concurridas — Siempre funciona mejor con la app cerrada.',
